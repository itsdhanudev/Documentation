...
Complete API reference for `ARadioButton`, including constructors, attributes, virtual attributes, and methods.
...
| --- | --- |
| ARadioButton() | Creates a new instance of ARadioButton. |
