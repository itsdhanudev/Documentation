# Vector3.greaterOrEqualsThan()

Instance method on `Vector3`.

## Description

- Checks if this Vector3 is greater than or equal to the specified object (by magnitude). |
- Checks if this Vector3 is greater than or equal to the specified value (by magnitude). |
- Checks if this Vector3 is greater than or equal to the specified value (by magnitude). |
- Checks if this Vector3 is greater than or equal to the specified value (by magnitude). |
- Checks if this Vector3 is greater than or equal to the specified value (by magnitude). |
...
```java
greaterOrEqualsThan(Object)
greaterOrEqualsThan(float)
greaterOrEqualsThan(int)
greaterOrEqualsThan(long)
greaterOrEqualsThan(double)
```
    ...
    <script>
      const sketch = (p) => {
        ...
        p.draw = () => {
          ...
          p.fill('#dbeafe');
          p.noStroke();
          p.text('Vector3 topic: vector3.greaterorequalsthan', 16, 24);
...
<iframe
  title="p5-vector3-greaterorequalsthan"
