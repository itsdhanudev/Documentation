...
- Multiplies this Vector3 by the specified Vector3 and returns a new Vector3. |
- Multiplies this Vector3 by the specified X, Y and Z values and returns a new Vector3. |
- Multiplies this Vector3 by the specified value and returns a new Vector3. |
- Returns the multiplication of this Vector3 by the specified object. |
    ...
    <script>
      const sketch = (p) => {
        ...
        p.draw = () => {
          ...
          p.fill('#dbeafe');
          p.noStroke();
          p.text('Vector3 topic: vector3.mul', 16, 24);
