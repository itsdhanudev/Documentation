# Vector3.rotateAroundPivot()

Instance method on `Vector3`.

## Description

- Rotates this Vector3 around the specified pivot point using the given rotation angles (in degrees) and returns the resulting Vector3. |
- Rotates this Vector3 around the specified pivot point using the given rotation Vector3 (in degrees) and returns the resulting Vector3. |
- Rotates this Vector3 around the specified pivot point using the given Quaternion rotation and returns the resulting Vector3. |
    ...
    <script>
      const sketch = (p) => {
        ...
        p.draw = () => {
          ...
          p.fill('#dbeafe');
          p.noStroke();
          p.text('Vector3 topic: vector3.rotatearoundpivot', 16, 24);
...
<iframe
  title="p5-vector3-rotatearoundpivot"
