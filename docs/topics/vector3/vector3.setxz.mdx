...
- Sets the X and Z components of this Vector3 with the values of the specified Vector2. |
- Sets the X and Z components of this Vector3. |
    ...
    <script>
      const sketch = (p) => {
        ...
        p.draw = () => {
          ...
          p.fill('#dbeafe');
          p.noStroke();
          p.text('Vector3 topic: vector3.setxz', 16, 24);
