...
Referência completa da API de `ALinearLayout`, incluindo construtores, atributos, atributos virtuais e métodos.
...
| --- | --- |
| ALinearLayout() | Cria uma nova instância de ALinearLayout. |
