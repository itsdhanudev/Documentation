...
| --- | --- |
| AListView([Context]) | Cria uma nova instância de AListView. |
...
| setOnItemClickListener([OnItemClickListener]) | [void] | Define ou atualiza a propriedade `propriedade `on item click listener``. |
| setOnItemLongClickListener([OnItemLongClickListener]) | [void] | Define ou atualiza a propriedade `propriedade `on item long click listener``. |
| setOnItemSelectedListener([OnItemSelectedListener]) | [void] | Define ou atualiza a propriedade `propriedade `on item selected listener``. |
