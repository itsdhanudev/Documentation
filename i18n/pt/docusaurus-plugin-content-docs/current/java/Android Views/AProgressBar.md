...
Referência completa da API de `AProgressBar`, incluindo construtores, atributos, atributos virtuais e métodos.
...
| --- | --- |
| AProgressBar() | Cria uma nova instância de AProgressBar. |
| AProgressBar([String]) | Cria uma nova instância de AProgressBar. |
