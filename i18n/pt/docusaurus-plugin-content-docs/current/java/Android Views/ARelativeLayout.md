...
Referência completa da API de `ARelativeLayout`, incluindo construtores, atributos, atributos virtuais e métodos.
...
| --- | --- |
| ARelativeLayout() | Cria uma nova instância de ARelativeLayout. |
