...
Referência completa da API de `ASeekBar`, incluindo construtores, atributos, atributos virtuais e métodos.
...
```java
public class ASeekBar extends SeekBar
```
...
| --- | --- |
| ASeekBar() | Cria uma nova instância de ASeekBar. |
