...
| findComponent([String]) | &[lt];[T] [extends] [Component]&[gt]; [T] | Executa a operação findComponent usando os parâmetros informados (tittle). |
| findComponents([String]) | [List]&[lt];[Component]&[gt]; | Executa a operação findComponents usando os parâmetros informados (tittle). |
| findComponent([Class]) | &[lt];[T] [extends] [Component]&[gt]; [T] | Executa a operação findComponent usando os parâmetros informados (classReference). |
...
| findComponentInChildren([String]) | &[lt];[T] [extends] [Component]&[gt]; [T] | Executa a operação findComponentInChildren usando os parâmetros informados (tittle). |
| findComponentInChildren([Class]) | &[lt];[T] [extends] [Component]&[gt]; [T] | Executa a operação findComponentInChildren usando os parâmetros informados (classReference). |
| findComponentInParent([String]) | &[lt];[T] [extends] [Component]&[gt]; [T] | Executa `findComponentInParent` e retorna quando a chamada do motor termina. |
| findComponentInParent([Class]) | &[lt];[T] [extends] [Component]&[gt]; [T] | Executa `findComponentInParent` e retorna quando a chamada do motor termina. |
