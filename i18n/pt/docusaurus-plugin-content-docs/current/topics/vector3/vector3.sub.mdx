...
- Subtracts the specified Vector3 from this Vector3 and Retorna Um novo Vector3. |
- Subtracts the specified X, Y and Z values from this Vector3 and Retorna Um novo Vector3. |
- Subtracts the specified value from this Vector3 and Retorna Um novo Vector3. |
- Retorna the subtraction of this Vector3 and the specified object. |
    ...
    <script>
      const sketch = (p) => {
        ...
        p.draw = () => {
          ...
          p.fill('#dbeafe');
          p.noStroke();
          p.text('Tópico Vector3: vector3.sub', 16, 24);
